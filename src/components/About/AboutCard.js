            ...
            <Card.Body>
                <blockquote className="blockquote mb-0">
                    <p style={{ textAlign: "justify" }}>
                        Hi Everyone, I am <span className="purple"> Rehan Yousuf </span>
                        from <span className="purple">Korangi Crossing , Karachi, Pakistan. </span>
                        <br />
                    ...
                    <footer className="blockquote-footer"> Rehan Yousuf </footer>
                </blockquote>
            </Card.Body>
        </Card>
    );
